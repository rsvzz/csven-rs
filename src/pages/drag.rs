...
use gtk::prelude::*;
use gtk::{Box, Orientation, Entry, Button, Align, GridView, glib, SignalListItemFactory, NoSelection};
...
impl Drag {
    pub fn build() -> Self{
        ...
        let word_et = Entry::builder().placeholder_text("type a word").build();
