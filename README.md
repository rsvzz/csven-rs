...
[![Get it Launchpad](https://launchpadlibrarian.net/606381979/CoF%2064px.png)](https://launchpad.net/~rsvzz/+archive/ubuntu/csven)

    sudo add-apt-repository ppa:rsvzz/csven
    sudo apt update
    sudo apt install csven
